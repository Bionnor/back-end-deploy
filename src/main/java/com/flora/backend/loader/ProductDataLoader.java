...
public class ProductDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        FinalProduct product1 = new FinalProduct();
        ...
        FinalProduct product2 = new FinalProduct();
        ...
        FinalProduct productTV = new FinalProduct();
        ...
        FinalProduct productMonitor = new FinalProduct();
        ...
        FinalProduct product3 = new FinalProduct();
        ...
        FinalProduct product4 = new FinalProduct();
        ...
        FinalProduct product5 = new FinalProduct();
